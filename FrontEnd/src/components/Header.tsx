                    ...
                    <div className="absolute right-0 mt-2 w-56 bg-white border border-slate-200 rounded-2xl shadow-xl py-1 z-[200]">
                      ...
                      <div className="py-1 border-b border-slate-100">
                        <Link
                          ...
                          className="w-full text-left px-4 py-2 text-xs font-bold text-violet-700 hover:bg-violet-50 transition-colors cursor-pointer flex items-center gap-2"
                        >
                        ...
                        {user?.email?.toLowerCase().trim() === 'admin123@gmail.com' && (
                          <button
                            onClick={() => {
                              const targetRole: UserRole = isAdmin ? 'RECRUITER_MEMBER' : 'ADMIN';
                              setRole(targetRole);
                              setDropdownOpen(false);
                            }}
                            className="w-full text-left px-4 py-2 text-xs font-semibold text-slate-600 hover:bg-slate-50 transition-colors cursor-pointer flex items-center gap-2"
                          >
                            <span className="text-xs">🔄</span>
                            <span>{isAdmin ? 'Switch to TA Recruiter Role' : 'Switch to Admin Role'}</span>
                          </button>
                        )}
                      </div>
