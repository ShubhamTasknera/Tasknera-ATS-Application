    ...
    <div className="min-h-screen bg-[#060C1A] text-white flex flex-col justify-between">
      ...
      <main className="max-w-7xl mx-auto px-6 pt-28 pb-16 flex-1 w-full">
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-sm">Configure system preferences, user roles, and evaluation criteria defaults.</p>
        </div>
        <div className="bg-[#0F172A]/70 border border-gray-800 rounded-2xl p-12 text-center">
          ...
          <p className="text-gray-400 text-sm max-w-md mx-auto">
            Account preferences, integrations, and ATS configuration options will be accessible here.
          </p>
        </div>
      </main>
      <Footer />
