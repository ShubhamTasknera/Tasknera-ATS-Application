          ...
          <div className="p-7 sm:p-8">
            <div className="mb-6">
              ...
              <p className="text-slate-500 text-xs mt-1">
                Start managing requisitions and evaluating CVs with AI
              </p>
            </div>
            ...
            <div className="relative mb-5 text-center">
              ...
              <span className="relative bg-white px-3 text-[11px] font-bold tracking-wider text-slate-400 uppercase">Or register with email</span>
            </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-xs text-slate-500">
                ...
                <Link href="/signin" className="text-brand-orange font-bold hover:underline">
                  Sign in
                </Link>
              </p>
            </div>
